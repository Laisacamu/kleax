    ...
    public class Finalizando_compra extends AppCompatActivity {
        ...
        private void cargarDatosCompra() {
            ...
            tvMetodoPago.setText(metodoPago); // Muestra el método de pago selecciona

            // Obtener los datos del usuario y de la compra
                ...
                public void onResponse(Call<Map<String, Object>> call, Response<Map<String, Object>> response) {
                    if (response.isSuccessful() && response.body() != null) {
                        ...
                        if (items != null && !items.isEmpty()) {
                            Map<String, Object> user = items.get(0);  // El primer usuario
                            String userId = (String) user.get("id");  // Obtener el 'id' correcto
                            Log.d("FinalizandoCompra", "userId obtenido: " + userId);  // Verifica si el userId es válido
                            ...
                            if (userId != null) {
                                ...
                                // Llamar a la función obtenerCarrito con el userId guardado
                                obtenerCarrito(userId);
                                obtenerMetodoPago(userId);
                            } else {
                                Log.e("FinalizandoCompra", "userId es nulo");
                                Toast.makeText(Finalizando_compra.this, "Error al obtener el ID de usuario", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                        ...
                        Log.e("FinalizandoCompra", "Error al obtener datos del usuario");
                        Toast.makeText(Finalizando_compra.this, "Error al obtener datos del usuario", Toast.LENGTH_SHORT).show();
                    }
                }
